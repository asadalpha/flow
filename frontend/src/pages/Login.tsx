...
export default function Login() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            <Card className="glass-card w-full max-w-md animate-scale-in hover-lift border-0 shadow-2xl relative z-10 backdrop-blur-xl">
                <CardHeader className="space-y-3 pb-6">
                    <div className="flex items-center gap-3 mb-2 justify-center">
                        <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg hover:scale-105 transition-transform duration-300">
                            <div className="w-3 h-3 rounded-full bg-black" />
                        </div>
                    </div>
                    <div className="text-center">
                        <h1 className="text-3xl font-heading font-bold tracking-tight text-white mb-1">Flow</h1>
                        <CardTitle className="text-xl font-medium text-muted-foreground">Welcome back</CardTitle>
                    </div>
                ...
                <CardContent>
                    <div className="space-y-4">
                        ...
                        <Button
                            type="button"
                            variant="outline"
                            className="w-full h-12 font-medium transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] border-white/10 hover:bg-white/5 bg-white/[0.02]"
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    {...register('email')}
                                    className="h-11 transition-all duration-200 focus:ring-2 focus:ring-ring/20 bg-black/20 border-white/10"
                                />
                ...
                <CardFooter className="border-t border-white/5 pt-6 bg-black/10">
